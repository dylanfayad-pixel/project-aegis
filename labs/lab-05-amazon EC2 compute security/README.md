...
A separate Security Group protects the Systems Manager VPC endpoints and allows HTTPS traffic on TCP port 443 only from the EC2 Security Group.
...
IMDSv2 uses token-based authentication to strengthen protection of instance metadata.
